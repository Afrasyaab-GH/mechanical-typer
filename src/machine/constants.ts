...
export const IMPACT_MS = 70; // visible & snappy type slug impact after keystroke
export const TYPEBAR_CYCLE_MS = 150; // full typebar rise + return
export const CARRIAGE_RETURN_MS = 620; // complete carriage return
export const CLASH_WINDOW_MS = 25; // typebar collision window
export const CLASH_DELAY_MS = 40; // stagger applied after a clash
export const LINKAGE_MS = 15; // link-rod pull event
export const ESCAPEMENT_MS = 75; // escapement release event
export const CARRIAGE_STEP_MS = 75; // one-cell carriage movement
