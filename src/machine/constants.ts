...
export const IMPACT_MS = 100; // type slug impact after keystroke
export const TYPEBAR_CYCLE_MS = 240; // full typebar rise + return
export const CARRIAGE_RETURN_MS = 720; // complete carriage return
export const CLASH_WINDOW_MS = 40; // typebar collision window
export const CLASH_DELAY_MS = 70; // stagger applied after a clash
export const LINKAGE_MS = 20; // link-rod pull event
export const ESCAPEMENT_MS = 120; // escapement release event
export const CARRIAGE_STEP_MS = 110; // one-cell carriage movement
